...
public class Main { // объект для тестов
    ...
    public static void main(String[] args) {
        Task task = new Task("Уборка", "Выполнить полную уборку");
        Epic epic = new Epic("Приготовить ужин", "Ужин из 3 блюд");
        Epic epic1 = new Epic("Приготовить завтрак", "Завтрак из 3 блюд");
        Subtask subtask1 = new Subtask("Нарезать картошку", "Нарезать картошку мелко", 2);
        Subtask subtask2 = new Subtask("Вскипятить воду", "Вскипятить воду в кастрюле", 2);
        Subtask subtask3 = new Subtask("Яичница", "Пожарить яичницу", 3);
        Subtask subtask4 = new Subtask("Кофе", "Сварить кофе", 3);
